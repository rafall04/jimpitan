 ...
 * Deps: None.
 * MainFuncs: Defines stable symbols for Auth repository, hashing, token, and session ID factory ports.
 * SideEffects: None.
 */
export const AUTH_REPOSITORY = Symbol('AUTH_REPOSITORY');
export const PASSWORD_HASHER = Symbol('PASSWORD_HASHER');
export const AUTH_TOKEN_SERVICE = Symbol('AUTH_TOKEN_SERVICE');
export const AUTH_SESSION_ID_FACTORY = Symbol('AUTH_SESSION_ID_FACTORY');
