...
- PostCSS advisory through Next is a documented accepted temporary risk in `docs/security/audit.md`.
...
- Confirm the only remaining production audit advisory is the accepted Next/PostCSS item.
